...
# how do you train an encoder with the values staying between -1 and 1 overall as well 
# N(0,1) kind of an encoder and an autoencoder overall as well ; that is what all these things mean overall as well 
...
# results save folder
# all  the random results and all tehg fixed results overall as well 
...
# along with this learn an encoder module which learn to infer inside the latent space as well 
